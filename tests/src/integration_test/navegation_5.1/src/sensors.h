...
class Sensors{
    private:
        ...
        array<double, 6> position = {0, 0, 0, 0, 0, 0};   // Position {x, y, z, roll, yaw, pitch} // possivelmente precisa atualizar os valores para o valor atual dos sensores na inicialização
